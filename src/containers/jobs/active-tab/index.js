...
const ActiveTab = () => {
  ...
  return (
    <Container>
      {jobsList.map(
        ({ name, city, date, status, duration, price, logo, rating }) => (
          <CardJob
            key={name}
            name={name}
            city={city}
      ...
      >
        ...
        <ModalFooter>
          ...
          <ModalFooterText>
            Failure to report on time may result in a negative rating review
            and/or termination. If you cannot make your route, please call
            xxx-xxx-xxxx as soon as possible so we can assist you.
          </ModalFooterText>
